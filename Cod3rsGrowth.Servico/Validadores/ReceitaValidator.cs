...
namespace Cod3rsGrowth.Servico.Validadores
{
    public class ReceitaValidator : AbstractValidator<Receita>
    {
        ...
        {
            int valorMinimoParaValidadeEmMeses = 1;
            RuleFor(p => p.Nome)
            ...
            RuleFor(p => p.ValidadeEmMeses)
                ...
                .GreaterThanOrEqualTo(valorMinimoParaValidadeEmMeses).WithMessage("Campo Validade em meses deve ser maior ou igual a 1"); 
        }
    }
}
